...
#SBATCH --output=logs/pyrosetta_ppdiff_%A_%a.out
...
COLABFOLD_DIR=~/master_thesis/results/colabfold/ppdiff/${TARGET}
OUTPUT_DIR=~/master_thesis/results/pyrosetta/ppdiff
